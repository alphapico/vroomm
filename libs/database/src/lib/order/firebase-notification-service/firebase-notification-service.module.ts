import { FirebaseAdminModule } from '../../nestjs-firebase-admin';
import { DynamicModule, Logger, Module } from '@nestjs/common';
import * as admin from 'firebase-admin';
import { existsSync, promises as fs } from 'fs';

import { DriverNotificationService } from './driver-notification.service';
import { PassengerNotificationService } from './passenger-notification.service';
  ...
  static async register(): Promise<DynamicModule> {
    ...
    if (existsSync(configAddress)) {
      ...
      if (
        ...
        providers = [DriverNotificationService, PassengerNotificationService];
      }
    }
    return {
