...
import 'bloc/passenger_profile_cubit.dart';
...
class DrawerLoggedIn extends StatelessWidget {
  final GetCurrentOrder$Query$Passenger passenger;

  const DrawerLoggedIn({required this.passenger, Key? key}) : super(key: key);
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(
            children: [
              ...
              Text(
                passenger.firstName != null || passenger.lastName != null
          ...
          ListTile(
            ...
            onTap: () async {
              ...
              Future.delayed(const Duration(milliseconds: 500), () {
                context.read<PassengerProfileCubit>().updateProfile(null);
              });
